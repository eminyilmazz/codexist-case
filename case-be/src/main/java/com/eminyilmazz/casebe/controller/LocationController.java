...
public class LocationController {
    ...
    public List<PlaceDTO> get(@RequestParam(name = "long") double longitude, @RequestParam(name = "lat") double latitude, @RequestParam(name = "rad", required = false, defaultValue = "1000") int rad) {
